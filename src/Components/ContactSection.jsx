  ...
  const socialLinks = [
    {
      icon: Linkedin,
      label: "LinkedIn",
      value: "https://www.linkedin.com/in/dhanushika-madushani/",
      color: "hover:text-blue-500",
    },
    {
      icon: Instagram,
      label: "Instagram",
      value: "https://www.instagram.com/dhanu.madushani/",
      color: "hover:text-pink-500",
    },
    {
      icon: Github,
      label: "GitHub",
      value: "https://github.com/DhanushikaGit",
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="group flex items-start gap-3 p-4 rounded-xl border border-border
                      hover:border-primary/30 hover:bg-primary/5 transition-all duration-300"
                    >
                      <div
                        className={`p-2 rounded-lg bg-secondary group-hover:scale-110 transition-transform duration-300 ${social.color}`}
                      >
              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                    ...
                    discussion, I'm just one email away. Let's turn your ideas
                    into reality.
                  </p>
                </div>
